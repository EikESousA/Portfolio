...
describe('ShowDevsService', () => {
  ...
  it('should be able to show all the developers nearby and with the technology!', async () => {
    ...
    const request_create_dev_3 = await request(server)
      .post('/devradar/devs')
      .send({
    ...
    const create_dev_3 = request_create_dev_3.body as IDev;
    ...
    expect(search_dev).toEqual([create_dev_1, create_dev_2, create_dev_3]);
